...
contract VaultsTest is DSTestPlus {
    ...
    function test_withdrawals_function_properly() public {
        uint256 amount = 1e18;
    ...
    function test_exit_pool_functions_properly() public {
        uint256 amount = 1e18;
    ...
    function test_weth_exit_pool_functions_correctly() public {
        uint256 amount = 1e18;
    ...
    function test_weth_float_pull_functions_correctly() public {
        uint256 amount = 1e18;
